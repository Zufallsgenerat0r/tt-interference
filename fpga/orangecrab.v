/*
 * OrangeCrab ECP5-85F wrapper for tt_um_kilian_waves
 * PLL generates 25.2 MHz VGA pixel clock from 48 MHz oscillator.
 * Falls back to 24 MHz divider if PLL doesn't work on your board.
 */
...
// ECP5 PLL: 48 MHz -> 25.6 MHz (generated by ecppll)
// VCO = 48 * 8 / 15 * 23 = 588.8 MHz
module pll_25m (
    input  wire clki,
    output wire clko,
    output wire locked
